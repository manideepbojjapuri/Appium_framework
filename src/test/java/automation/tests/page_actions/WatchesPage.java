...
public class WatchesPage extends Page {
    ...
    public void selectWatch() {
        waitUntilElementIsVisible(waitInSeconds, elementFinder.element("watchSelection"));
        clickElement(elementFinder.element("watchSelection"));
        //elementFinder.element("watchSelection").click();
    }

    public void deleteWatch() {
        if(isElementDisplayed(elementFinder.element("deleteWatch"),waitInSeconds)) {
            clickElement(elementFinder.element("deleteWatch"));
        }
//        try{
