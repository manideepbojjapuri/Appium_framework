...
public class FastrackSmartAutomation extends BaseTests implements ConnectToFastrackApp {
    ...
    public void connectToFastTrackApp() {
        ...
        getScannerPageAction().clickPermissionDropdown((String) yamlManager.get("cameraPermissionTitle"));
        getScannerPageAction().clickPermissionDropdown((String) yamlManager.get("locationRequiredPermissionTitle"));
        getScannerPageAction().clickPermit();
        Assert.assertEquals(getScannerPageAction().getResourcePermissionPopupMessage(),locationPermissionPopupTitle,"Location required permission popup title is not matching");
        getScannerPageAction().clickAllowOnlyUsingTheApp();
        Assert.assertTrue(getScannerPageAction().isPermittedMessageDisplayed(),"Permitted message is not displayed");
        getScannerPageAction().clickPermissionDropdown((String) yamlManager.get("locationRequiredPermissionTitle"));


        getScannerPageAction().clickPermissionDropdown((String) yamlManager.get("locationOffPermissionTitle"));
        getScannerPageAction().clickPermit();
